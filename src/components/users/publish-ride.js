  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <form className="max-w-lg mx-auto" onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <label className="block text-sm font-semibold mb-2">Instant Booking</label>
          <input type="checkbox" id="instantBooking" name="instantBooking" checked={rideDetails.instantBooking} onChange={handleChange} className="mr-2 leading-tight" />
          <span className="text-sm">Allow instant booking</span>
        </div>
        <div className="mb-6">
          <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Publish Ride</button>
        </div>
      </form>
    </div>
  );
